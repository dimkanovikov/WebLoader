...
void WebLoader::setWebRequest(WebRequest *request) {
    this->m_request = request;
}

void WebLoader::loadAsync(QString urlToLoad, QUrl referer)
{
...
QByteArray WebLoader::loadSync(QString urlToLoad, QUrl referer)
{
